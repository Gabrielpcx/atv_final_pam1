...
const categoria = [
    {
        codigo_categoria:1,
        titulo_categoria: 'HQs',
        imagem_categoria:require('../assets/imagens/hq/hq.jpeg'),
    },
    {
      codigo_categoria:2,
      titulo_categoria: 'Terror',
      imagem_categoria:require('../assets/imagens/terror/terror.webp'),
    },
    {
      codigo_categoria:3,
      titulo_categoria: 'Progamação',
      imagem_categoria:require('../assets/imagens/progamacao/progamacao.jpg'),
    },
    {
      codigo_categoria:4,
      titulo_categoria: 'Historia',
      imagem_categoria:require('../assets/imagens/historia/historia.jpg'),
    },
];
